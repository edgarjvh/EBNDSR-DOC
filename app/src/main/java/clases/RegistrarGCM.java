...
public class RegistrarGCM {
    ...
    private static final String SENDER_ID = "891585435308";
    private static final String SERVER_API = "AIzaSyAoCrmzYzgYgPYmEjQeEx2HIlE4wlu2u18";
    ...
    private boolean registroServidor(String regId){
        ...
        request.addProperty("tipo", 0); // 0 = registro de docente; 1 = registro de representante
        request.addProperty("id", docente.getId());
